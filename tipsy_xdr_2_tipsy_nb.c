...
** ts2tb.c
**
** Program written in order to convert tipsy standard binary format to tipsy binary format
**
...
void usage(void) {
    ...
    fprintf(stderr,"> output file in tipsy binary format\n");
    fprintf(stderr,"\n");
    exit(1);
    }
