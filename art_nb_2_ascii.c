...
/*             } */
    ...
    */
    ...
    fprintf(stdout,"#rx/1 ry/2 rz/3 vx/4 vy/5 vz/6 l/7 V/8 rho_gas/9 rho_HI/10 rho_HII/11 rho_H2/12 rho_HeI/13 rho_HeII/14 rho_HeIII/15");
    fprintf(stdout," energy/16 pressure/17 gamma/18 internal_energy/19 metal_density_SNII/20 metal_density_SNIa/21");
    fprintf(stdout,"\n");
		...
		if ((cellrefined[j] == 0) || (i == Lmaxgaswrite)) {
		    ...
		    */
			...
			if (agp.gas_density >= rhosel || fH2 >= fH2sel) {
			    ...
			    fprintf(stdout," %5.4e %5.4e %5.4e %5.4e",agp.gas_energy,agp.pressure,agp.gamma,agp.internal_energy);
